...
\node [scale=0.5,align=center] at (-2,-1.5) {Demande de\\cr̩dit $X_0$};
\node [scale=0.5,align=center] at (2,-2.5) {Financement du\\cr̩dit $X_{\text{fin}}$};
\node [scale=0.5,align=center] at (10,-1.5) {Divorce\\$X_{\text{divorce}}$};


\node [scale=0.5,align=center] at (2,1) {$Y_0$};
\node [scale=0.5,align=center] at (7,1.5) {Mensualit̩ i\\$Y_i$};
\node [scale=0.5,align=center] at (15,1.5) {Mensualit̩\\impay̩e};
\node [scale=0.5,align=center] at (20,1.5) {Cr̩dit\\termin̩ $Y_T$};
