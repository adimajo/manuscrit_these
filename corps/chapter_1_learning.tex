...
\svgpath{{./figures/chapitre1/}}
  ...
  \begin{figure}
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includesvg[width=0.45\textwidth]{Plusieurs_separatrice_lineaire}
        \vspace{-0.5cm}
        \caption{\label{fig:svm1} SVM blabla.\footnote{source...}}
    \end{subfigure}%
    
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includesvg[width=0.45\textwidth]{Separatrice_lineaire_avec_marges}
        \vspace{-0.5cm}
        \caption{\label{fig:svm2} SVM blablabla.}
    \end{subfigure}
