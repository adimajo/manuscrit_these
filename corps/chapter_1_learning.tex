...
On peut faire apparaître ce phénomène en mesurant l'écart quadratique moyen entre l'oracle $p_{\text{data}}$ et le modèle proposé $p_{\glssymbol{bth}}$ :
\begin{align*}
