...
\begin{multicols}{2}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption[SVM blabla.]{\label{fig:svm1} SVM blabla.\protect\footnotemark[1]}
    \end{subfigure}%
    \columnbreak
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=\textwidth]{Separatrice_lineaire_avec_marges}
        \caption[SVM blablabla.]{\label{fig:svm2} SVM blablabla.\protect\footnotemark[1]}
    \end{subfigure}
\end{multicols}
\caption{\label{fig:svm} SVM blablablablabla.}
\end{figure}
