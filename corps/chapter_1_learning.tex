...
%, dont on note la loi de probabilité (uniforme) $\ps$.
...
%$\mathbb{E}_{\gls{T}} [ p_{\hat{\gls{bth}}}(y| \gls{bx})] = p_{\gls{bthstar}}(y| \gls{bx})$.
