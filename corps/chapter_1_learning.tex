...
\centering\includegraphics[width=3.5cm]{figures/chapitre1/sofinco.png}

\centering \tikz [baseline=-1ex]{\node [myarrow,rotate=-135] {};} \tikz [baseline=-1ex]{\node [myarrow,rotate=-45] {};}

\column{.55\textwidth}

\centering \tikz [baseline=-1ex]{\node [myarrow,rotate=180] {};} \includegraphics[width=2.5cm]{figures/chapitre1/finaref.jpg}
...
\column{.25\textwidth}
\centering\includegraphics[width=1cm]{figures/chapitre1/fnac.png}
