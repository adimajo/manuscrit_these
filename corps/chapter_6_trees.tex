...
This membership is denoted by $\lambda(r,c)$ such that $x_{\sigma(r,c)} \in C_{\mathcal{P}a^r(c),\lambda(r,c)}$.
...
%These good candidates are given by the segments' latent feature distribution $p(c | \glssymbol{bx}, y)$.
