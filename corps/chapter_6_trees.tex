...
%\ln p(\gls{bby}, \gls{bbx}) & = \sum_{c=1}^{\gls{K}^\star} \exp \left( \frac{-\text{BIC}(\hat{\gls{bth}^c}) + O(1)}{2} \right) + \ln p(\gls{bbx}_\f).
\end{align}
Thus, we have:
\begin{align*}
...
%tree given in Figure~\ref{fig:tree_sem_auto} 
