...
\begin{figure}
\centering
\resizebox{.8\textwidth}{4cm}{\begin{tikzpicture}
      ...
      \draw[scale=1,domain=-0.2:2.8,smooth,variable=\x,blue]  plot (2.5,{\x});
		...
		\node[scale=0.7] (q1) at  (0.95,2.7) {\small $Q=(1,0,0)$};
		\node[scale=0.7] (q2) at  (1.95,2.7) {\small $Q=(0,1,0)$};
		\node[scale=0.7] (q3) at  (2.95,2.7) {\small $Q=(0,0,1)$};

		\node[scale=0.7] (x1) at  (0.5,-0.5) {$0$};
		\node[scale=0.7] (x2) at  (1.35,-0.5) {$c_1=1/3$};
		\node[scale=0.7] (x3) at  (2.65,-0.5) {$c_2=2/3$};
