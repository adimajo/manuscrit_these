...
\begin{table}
    \centering
\begin{tabular}{lp{0.191\linewidth}p{0.13\linewidth}p{0.15\linewidth}p{0.15\linewidth}}
Dataset & Additive linear logistic regression & \textit{ad hoc} methods & Our proposal: \textit{glmdisc}-NN & Our proposal: \textit{glmdisc}-SEM \\
\hline
...
\begin{table}
    \centering
\begin{tabular}{lp{0.191\linewidth}p{0.138\linewidth}p{0.13\linewidth}p{0.15\linewidth}p{0.15\linewidth}}
Portfolio & Additive linear logistic regression & Current \hspace{0.5cm} performance & \textit{ad hoc} methods & Our proposal: \textit{glmdisc}-NN & Our proposal: \textit{glmdisc}-NN \\
\hline
