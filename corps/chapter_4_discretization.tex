...
Firstly, only the well-specified model case is considered. This hypothesis formalized in Equation~\eqaref{eq:well_quant} for the neural network approach, translates with this new latent feature as a probabilistic assumption:
