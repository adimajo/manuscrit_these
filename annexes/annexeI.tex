...
%: $\ell(\glssymbol{bth};(\bm{1},\glssymbol{bbx})' \hat{\glssymbol{phi}}, (\bm{1},\glssymbol{bbx})' \hat{\glssymbol{bth}}_\f, \glssymbol{bby}) = \ell(\theta;\glssymbol{bbx}^{\text{f}}, \glssymbol{bby}^{\text{f}})$ where $\begin{cases}
%\glssymbol{bth} = (\theta_0,\theta_1,\theta_2). \\
