...
\subsection{Simulation of } \label{subsec:app_reject_real}
...
\begin{algorithm}[H]
 \KwData{$((\glssymbol{bbx}_j)_1^{d}, \glssymbol{bby}),\max\_\text{iter},\bm{m}_\text{start}$}
...
\begin{algorithm}[H]
 \KwData{$n,\glssymbol{bbx},\glssymbol{bby}, \max\_{\text{iter}}$}
