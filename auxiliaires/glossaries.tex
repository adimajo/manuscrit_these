...
\newglossaryentry{bx}{
        name={réalisation du vecteur de caractéristiques d'un client},
        description={},
        symbol={\ensuremath{\bm{x}}},
        type=symbols,
  	   sort={ag},  
...
\newglossaryentry{Xnotj}{
        name={vecteur aléatoire $\bm{X}$ privé de sa $j^{\text{ème}}$ composante},
        description={},
        symbol={\ensuremath{X_{-\{j\}}}},
        type=symbols,
  	   sort={ag},  
}

\newglossaryentry{xij}{
        name={réalisation de $X_j$ pour le $i^{\text{ème}}$ client (en colonne)},
        description={},
...
\newglossaryentry{bbx}{
        name={matrice de design de caractéristiques (en colonnes) d'un ensemble de clients (en lignes)},
        description={},
...
\newglossaryentry{y}{
        name={observation du caractère ``bon'' ($1$) ou ``mauvais'' ($0$) d'un client},
        description={},
        symbol={\ensuremath{y}},
        type=symbols,
  	   sort={am},  
...
\newglossaryentry{qj}{
        name={fonction de quantification univariée de la $j^{\text{ème}}$ composante},
        description={},
...
\newglossaryentry{bth}{
        name={vecteur de paramètres, généralement pour la régression logistique, du modèle prédictif de $Y$ conditionnellement aux caractéristiques $\bm{X}$},
        description={},
...
\newglossaryentry{phi}{
        name={paramètre du mécanisme d'acceptation / rejet ($Z$) des demandeurs de crédit conditionnellement aux données $\bm{X}$ et $Y$},
        description={},
...
\newglossaryentry{T}{
        name={ensemble d'observations d'apprentissage},
        description={},
...
\newglossaryentry{Tf}{
        name={ensemble d'observations de clients financés},
        description={},
        symbol={\ensuremath{\mathcal{T}_\f}},
        type=symbols,
  	   sort={au},  
}
...
\newglossaryentry{Tnf}{
        name={ensemble d'observations de clients non financés},
        description={},
        symbol={\ensuremath{\mathcal{T}_{\text{nf}}}},
        type=symbols,
  	   sort={av},  
}
