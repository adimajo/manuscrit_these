...
\title[Supervised and semi-supervised model-based classification]{Modèles de classification supervisée et semi-supervisée}
%
...
\subtitle[Controlling information loss in Credit Scoring]{Contrôle des pertes d’information inhérentes au scoring en risque de crédit}
%
...
\referee[professor,affiliation=Université de Rennes 1]{François}{Husson}
