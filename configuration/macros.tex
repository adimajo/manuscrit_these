...
\newcommand{\ag}{\glssymbol{ag}}

\newcommand{\betag}{\glssymbol{beta}}
...
\newcommand\q{\glssymbol{bq}}
\newcommand\Q{\glssymbol{bQ}}
\newcommand{\bdelta}{\glssymbol{bdelta}}
...
%\setlength{\glsnamewidth}{0.2\linewidth}
...
\def\mybarb#1#2{%%
\begin{tabular}{@{}l@{}} {\scriptsize #1} \vspace*{-0.2cm} \\ {\scriptsize #2} \end{tabular} & \resizebox{.05\textwidth}{0.5cm}{\begin{tabular}{@{}l@{}}{\color{green}\rule[-6pt]{#1bp}{10pt}} \\ {\color{orange}\rule[0pt]{#2bp}{10pt}} \end{tabular}}}

\def\myobarb#1#2{%%
\begin{tabular}{@{}l@{}} {\scriptsize #1} \vspace*{-0.2cm} \\ {\scriptsize #2} \vspace*{-0.2cm} \end{tabular} & \resizebox{.05\textwidth}{0.5cm}{\begin{tabular}{@{}l@{}}{\color{orange}\rule[-6pt]{#1bp}{10pt}} \\ {\color{green}\rule[0pt]{#2bp}{10pt}} \end{tabular}}}
...
\newcommand{\thetao}{\theta^{\text{opt}}}
\newcommand{\thetaof}{\theta_{\text{f}}^{\text{opt}}}
\newcommand{\thetaf}{\theta_{\text{f}}}
\newcommand{\Sigmao}{\Sigma^{\text{opt}}}
\newcommand{\Sigmaof}{\Sigma_{\text{f}}^{\text{opt}}}
